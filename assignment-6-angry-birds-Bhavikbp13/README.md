...
- 💯**Worth**: 12.5%
- 📅**Due**: November 15, 2021 @ 23:59
- 🙅🏽‍**Penalty**: Late submissions lose 10% per day to a maximum of 3 days. Nothing is accepted after 3 days and a grade of 0% will be given.

## 🎯 Objectives

- Read and understand all of the Angry Birds [notes](https://jac-cs-game-programming-f21.github.io/Notes/#/6-Angry-Birds/) and [source code](https://github.com/JAC-CS-Game-Programming-F21/6-Angry-Birds) from Lecture 6.
...
**Choose TWO** of the following _birds_ to implement. One bird must be either Blue or Yellow, and the other must be either White or Black. In other words, you can't do both Blue and Yellow unless, of course, you want to implement more than 2 birds!
