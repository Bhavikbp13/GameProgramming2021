...
import ExperienceBar from "../../user-interface/elements/ExperienceBar.js";
...
export default class BattleTurnState extends State {
	...
	constructor(battleState) {
		...
		this.battleState.playerPanel.battleState = this.battleState;
	...
	processLevelUp(experience) {
		...
		console.log(this.playerPokemon.currentExperience);
		...
		if (this.playerPokemon.currentExperience < this.playerPokemon.targetExperience) {
			this.playerPokemon.battleEnd = true;
		...
		this.playerPokemon.levelChange = true;
		...
		//console.log("display items");
			...
			//console.log(this.playerPokemon.tweenXP1)
			// while(this.playerPokemon.tweenXP1 == true){
			// 	console.log("waiting");
			// }
			//while(this.playerPokemon.tweenXP2 != true && this.playerPokemon.tweenXP1 != true){
				...
				// 							   Speed: ${oldSpeed} > ${this.playerPokemon.speed}`, Panel.POKEMON_STATS, () => this.battleState.exitBattle()));
			//}
