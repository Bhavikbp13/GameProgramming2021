...
- 💯**Worth**: 12%
- 📅**Due**: November 29, 2021 @ 23:59
- 🙅🏽‍**Penalty**: Late submissions lose 10% per day to a maximum of 3 days. Nothing is accepted after 3 days and a grade of 0% will be given.

## 🎯 Objectives

- Read and understand all of the Pokemon [notes](https://jac-cs-game-programming-f21.github.io/Notes/#/7-Pokemon/) and [source code](https://github.com/JAC-CS-Game-Programming-F21/7-Pokemon) from Lecture 7.
...
- The player Pokémon's health should still have the text indicator (ex. `HP: 4/12`) as well as the bar, whereas the opponent Pokémon's health should only have the bar.
