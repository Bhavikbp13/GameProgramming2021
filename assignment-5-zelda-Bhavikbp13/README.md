# Assignment 5 - Zelda ⚔️

- 💯**Worth**: 7.5%
- 📅**Due**: November 1, 2021 @ 23:59
- 🙅🏽‍**Penalty**: Late submissions lose 10% per day to a maximum of 3 days. Nothing is accepted after 3 days and a grade of 0% will be given.

## 🎯 Objectives

- Read and understand all of the Zelda [notes](https://jac-cs-game-programming-f21.github.io/Notes/#/5-Zelda/) and [source code](https://github.com/JAC-CS-Game-Programming-F21/5-Zelda) from Lecture 5.
...
4. Record a screencast, **not to exceed 5 minutes in length**, in which you demonstrate your game's functionality.
   ...
   - In your video's description, please timestamp where each of the following occurs in your gameplay demonstration:
     ...
     - Pot throw (all directions)
       - Each direction should be a different collision (wall, enemy, distance)
       - Each collision should result in a breaking/shattering animation along with the proper sound effect
