...
export default class SpriteManager {
	...
	static generateBrickSprites() {
		...
		let y = 0;
		const sprites = [];
		// sprites.push(new Sprite(images.spriteSheet, TILE_SIZE * 5, TILE_SIZE * 4,TILE_SIZE * 2, TILE_SIZE));
		// sprites.push(new Sprite(images.spriteSheet, TILE_SIZE * 5, TILE_SIZE * 4,TILE_SIZE * 2, TILE_SIZE));
		// sprites.push(new Sprite(images.spriteSheet, TILE_SIZE * 5, TILE_SIZE * 4,TILE_SIZE * 2, TILE_SIZE));
		for (let i = 0; i < 4; i++) {
			for (let j = 0; j < 6; j++) {
	...
	/**
	 * Retrieves the power up sprites
	 *
	 * @returns An array of paddle sprites.
	 */
	 static generatePowerUpSprites() {
		...
		//sprites.push(new Sprite(images.spriteSheet, TILE_SIZE * 7, TILE_SIZE * 12, 10, 10));
		sprites.push(new Sprite(images.spriteSheet, TILE_SIZE * 8, TILE_SIZE * 12, 16, 16));
		sprites.push(new Sprite(images.spriteSheet, TILE_SIZE * 9, TILE_SIZE * 12, 16, 16));
